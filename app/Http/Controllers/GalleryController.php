...
class GalleryController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('backend.gallery.show',compact('model'));
    }
    ...
    {
        $model = post::findOrFail($id);
        return view('backend.gallery.edit',compact('model'));
    }
    ...
    public function apiGallery()
    {
        ...
        ->addColumn('action', function($post){
            return '<a href="/admin/gallery_manager/'.$post->id.'/edit" class="btn btn-xs btn-outline-accent m-btn m-btn--icon m-btn--icon-only m-btn--outline-2x m-btn--pill m-btn--air" data-container="body" data-toggle="m-tooltip" data-placement="bottom" title="" data-original-title="Ubah Data"><i class="fa fa-pencil"></i>
                      </a>
                      <a href="/admin/gallery_manager/'.$post->id.'" class="btn btn-xs btn-outline-info m-btn m-btn--icon m-btn--icon-only m-btn--outline-2x m-btn--pill m-btn--air" data-container="body" data-toggle="m-tooltip" data-placement="bottom" title="" data-original-title="Ubah Data"><i class="fa fa-arrow-right"></i></a>';
        })

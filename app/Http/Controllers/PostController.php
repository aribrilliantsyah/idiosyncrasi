...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       $this->validate($request,[
        ...
        if($request->hasFile('image')){
            ...
            //cover
            $cover=Image::make($picture)->resize(960, null, function ($constraint) {
                $constraint->aspectRatio();
            });
        ...
        return redirect('/admin/blog_manager');
    ...
    public function show($id)
    {
        ...
        return view('backend.blog.show',compact('model'));
    }
    ...
    public function apiPost()
    {
        ...
        ->addColumn('action', function($post){
            return '<a href="/admin/blog_manager/'.$post->id.'/edit" class="btn btn-xs btn-outline-accent m-btn m-btn--icon m-btn--icon-only m-btn--outline-2x m-btn--pill m-btn--air" data-container="body" data-toggle="m-tooltip" data-placement="bottom" title="" data-original-title="Ubah Data"><i class="fa fa-pencil"></i>
                      </a>
                      <a href="/admin/blog_manager/'.$post->id.'" class="btn btn-xs btn-outline-info m-btn m-btn--icon m-btn--icon-only m-btn--outline-2x m-btn--pill m-btn--air" data-container="body" data-toggle="m-tooltip" data-placement="bottom" title="" data-original-title="Ubah Data"><i class="fa fa-arrow-right"></i></a>';
        })

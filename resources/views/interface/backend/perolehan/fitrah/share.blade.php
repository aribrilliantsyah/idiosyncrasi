		...
		<div class="m-portlet">
			<div class="m-portlet__head">
				...
				<div class="m-portlet__head-tools">
					<button class="btn btn-primary btn-sm m-btn--air" onclick="add_row('share')"><i class="fa fa fa-plus"></i> Tambah</button>
				</div>
			</div>
			<div class="m-portlet__body">
				...
				<form class="form" role="form" id="form">
					...
					<input type="hidden" name="id_count" value="{{ $fitrah->id }}">
					<table class="table table-bordered table-striped table-hover" id="share">
						<thead>
							<tr>
								<th>Mustahik</th>
								<th>Jumlah</th>
...
<script type="text/javascript">
        ...
        var row = "<tr id='"+table+"_"+total_row+"'>"+
                    "<td>"+
                        "<div class='form-group'>"+
	                        "<input type='text' class='form-control textbox' name='mustahik[]'></textarea>"+
	                        "<span class='text-danger'></span>"+
	                    "</div>"+
                    "</td>"+
                    "<td>"+
                    	"<div class='form-group'>"+
	                        "<input type='text' class='form-control textbox jumlah' name='jumlah[]'></textarea>"+
	                        "<span class='text-danger'></span>"+
                        "</div>"+
                    "</td>"+
                    "<td>"+
    ...
    $(document).ready(function(){
        ...
        $('#form').submit(function(e){
            ...
            if (valid){
                        $.ajax({
                            url: '/admin/pembagian/fitrah',
                            type: "POST",
                            data: $('#form').serialize(), 
                            dataType: "html",
                            success: function(){                
                            window.location = "{{ url('/admin/redirect/alokasi/fitrah') }}";
                            },	

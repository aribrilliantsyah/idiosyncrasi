...
<html lang="en">
  <head>
    ...
    <title>Islamic - Simple Landing Page</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
        <h1 class="text-center">Akan segera hadir!</h1>
        <h3 class="text-center">Waktu Tersisa :</h3>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="text-center copyright">Copyright &copy; 2017 Islamic by <a target="_blank" style="color:#fff;" href="https://www.karizutodev.ns1.epzy.com">Ari Ardiansyah</a></div> 
      </div>
    </div>

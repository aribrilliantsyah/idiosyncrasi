		...
		<div class="m-portlet m-portlet--mobile">
			<div class="m-portlet__head">
				...
				<div class="m-portlet__head-tools">
					<a href="{{ route('gallery_manager.create') }}" class="btn btn-sm btn-accent m-btn--air m-btn--pill "><i class="fa fa-plus"></i> Tambah Gambar </a>
	  ...
	  if(id.length === 0) //tell you if the array is empty
	   {
	    swal({
   		...
   		swal({
			  ...
			  $.ajax({
				     url:'{{ url('admin/gallery_manager/delsel') }}',
				     method:'POST',
				     data:{
				     		'_token': '{{ csrf_token() }}',
				     		'id':id

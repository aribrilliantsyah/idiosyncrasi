				...
				<div class="m-widget19">
					<div class="m-widget19__content">
						<div class="m-widget19__body">
							<form class="form-horizontal" method="post" action="{{ route('gallery_manager.update',$model->id) }}" files="true" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="text" name="title" class="form-control input" value="{{ $model->judul }}" >
									 @if ($errors->has('title'))
								...
								<div class="form-group">
									...
									<input type="text" name="price" class="form-control input" value="{{ old('price') }}" value="{{ $model->price }}">
								...
								<img src="{{ asset('/img/cover/'.$model->picture) }}" style="border-radius: 20px;width: 80%">
								@endif
								<div class="form-group">
									<label for="recipient-name" class="form-control-label">
										Kategori
									...
									<select name="kategori_id" class="form-control select2">
										@php
										$kat = App\KategoriGallery::all();
										@endphp
										<option value="">-</option>
										@foreach($kat as $data)
										@if($model->kategori_id == $data->id)

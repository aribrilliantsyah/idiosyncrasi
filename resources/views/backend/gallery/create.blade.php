				...
				<div class="m-widget19">
					<div class="m-widget19__content">
						<div class="m-widget19__body">
							<form class="form-horizontal" method="post" action="{{ route('gallery_manager.store') }}" files="true" enctype="multipart/form-data">
								{{ csrf_field() }}
								...
								<div class="form-group">
									...
									<input type="text" name="price" class="form-control input" value="{{ old('price') }}">
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="content" id="post">
										...
										@if(isset($laporan))
										  @if($jenis == "fitrah")
										  @include('template.blog.template_fitrah')
										  @elseif($jenis == "mal")
										  @include('template.blog.template_mal')
										  @elseif($jenis == "amal")
										   @include('template.blog.template_amal')
										  @endif
										@endif
									</textarea>

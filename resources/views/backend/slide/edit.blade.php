				...
				<div class="m-widget19">
					<div class="m-widget19__content">
						<div class="m-widget19__body">
							<form class="form-horizontal" method="post" action="{{ route('slide.update', $model->id) }}" files="true" enctype="multipart/form-data">
								{{ csrf_field() }}
								...
								<div class="form-group">
	                                ...
	                                @endif
                                    @if($model->img != null)
                                    <img src="{{ asset('/img/slide/'.$model->img) }}" style="border-radius: 20px;width: 300px">
                                    @endif
								</div>
